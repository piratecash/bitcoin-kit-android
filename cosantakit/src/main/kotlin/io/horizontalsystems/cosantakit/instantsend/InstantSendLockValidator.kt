...
class InstantSendLockValidator(
     ...
     * @throws CosantaKitErrors.ISLockValidation.InvalidStructure if structural validation fails
     */
    @Throws(CosantaKitErrors.ISLockValidation.InvalidStructure::class)
    ...
    private fun ensureTriviallyValid(islock: ISLockMessage) {
        if (islock.inputs.isEmpty()) {
            ...
            throw CosantaKitErrors.ISLockValidation.InvalidStructure()
        }
