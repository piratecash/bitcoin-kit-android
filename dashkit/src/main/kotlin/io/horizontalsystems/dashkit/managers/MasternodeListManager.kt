...
class MasternodeListManager(
    ...
    fun updateList(masternodeListDiffMessage: MasternodeListDiffMessage) = synchronized(updateLock) {
        ...
        //04.
        val hash =
            masternodeListMerkleRootCalculator.calculateMerkleRoot(masternodeSortedList.masternodes)
        ...
        val calculatedMerkleRoot = merkleBranch.calculateMerkleRoot(
            masternodeListDiffMessage.totalTransactions.toInt(),
            masternodeListDiffMessage.merkleHashes,
            masternodeListDiffMessage.merkleFlags,
            matchedHashes
        )
